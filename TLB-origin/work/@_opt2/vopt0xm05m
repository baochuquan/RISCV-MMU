...
entity TLB is
    generic(
        S_ready         : vl_logic_vector(0 to 1) := (Hi0, Hi0);
        S_request       : vl_logic_vector(0 to 1) := (Hi0, Hi1);
        S_wait          : vl_logic_vector(0 to 1) := (Hi1, Hi0);
        S_wait_invalidate: vl_logic_vector(0 to 1) := (Hi1, Hi1)
    );
    port(
        clock           : in     vl_logic;
        reset           : in     vl_logic;
    ...
    attribute mti_svvh_generic_type of S_request : constant is 1;
    attribute mti_svvh_generic_type of S_wait : constant is 1;
    attribute mti_svvh_generic_type of S_wait_invalidate : constant is 1;
end TLB;
